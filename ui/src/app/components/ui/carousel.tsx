  ...
  return (
    <div className={cn("flex flex-col gap-2", className)} {...props}>
      <div ref={emblaRef} className="overflow-hidden h-full">
        <div
          className="-ml-4 flex touch-pan-y h-full"
          style={{
        ...
        >
          {images.map((image, index) => (
            <div
              className="relative min-w-0 w-full h-full flex-[0_0_100%]"
              key={index}
            >
              <Image
      ...
      {showPreview && images.length > 1 ? (
        <div className="flex w-full items-center justify-center gap-2">
          <Button
            variant="outline"
            //size="icon"
            className="mr-0.5 aspect-square h-7 w-7 rounded-none sm:mr-2 sm:h-8 sm:w-auto p-0"
          ...
          <Button
            variant="outline"
            //size="icon"
            className="ml-0.5 aspect-square h-7 w-7 rounded-none sm:ml-2 sm:h-8 sm:w-8 p-0"
