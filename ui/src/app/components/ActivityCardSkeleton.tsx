export const ActivityCardSkeleton = () => {
    return (
        <div className="block w-full p-2 border-b border-white/30 lg:flex lg:flex-wrap animate-pulse">
            <div className="block justify-start w-full sm:w-5/12 lg:flex lg:flex-wrap">
                <div className="self-center flex-none w-full px-4 py-1 mr-6 rounded sm:w-32 opacity-60">
                </div>
                <div
