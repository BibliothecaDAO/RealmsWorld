...
export type SpaceFragmentFragment = { __typename?: 'Space', id: string, controller: string, voting_delay: number, min_voting_period: number, max_voting_period: number, proposal_threshold: any, validation_strategy: string, validation_strategy_params: any, voting_power_validation_strategy_strategies: Array<string | null>, voting_power_validation_strategy_strategies_params: Array<string | null>, strategies_indicies: Array<number | null>, strategies: Array<string | null>, strategies_params: Array<string | null>, authenticators: Array<string | null>, proposal_count: number, vote_count: number, created: number, metadata?: { __typename?: 'SpaceMetadataItem', name: string, avatar: string, cover: string, about: string, external_url: string, github: string, twitter: string, discord: string, voting_power_symbol: string, treasuries: Array<string | null>, delegations: Array<string | null>, executors: Array<string | null>, executors_types: Array<string | null>, executors_destinations: Array<string | null>, executors_strategies: Array<{ __typename?: 'ExecutionStrategy', id: string, address: string, destination_address?: string | null, type: string, treasury_chain?: number | null, treasury?: string | null } | null> } | null, voting_power_validation_strategies_parsed_metadata: Array<{ __typename?: 'VotingPowerValidationStrategiesParsedMetadataItem', index: number, data?: { __typename?: 'StrategiesParsedMetadataDataItem', id: string, name: string, description: string, decimals: number, symbol: string, token?: string | null, payload?: string | null } | null } | null>, strategies_parsed_metadata: Array<{ __typename?: 'StrategiesParsedMetadataItem', index: number, data?: { __typename?: 'StrategiesParsedMetadataDataItem', id: string, name: string, description: string, decimals: number, symbol: string, token?: string | null, payload?: string | null } | null } | null> } & { ' $fragmentName'?: 'SpaceFragmentFragment' };

export type ProposalFragmentFragment = { __typename?: 'Proposal', id: string, proposal_id: number, quorum: any, execution_hash: string, start: number, min_end: number, max_end: number, snapshot: number, scores_1: any, scores_2: any, scores_3: any, scores_total: any, execution_time: number, execution_strategy: string, execution_strategy_type: string, execution_destination?: string | null, timelock_veto_guardian?: string | null, strategies_indicies: Array<number | null>, strategies: Array<string | null>, strategies_params: Array<string | null>, created: number, edited?: number | null, tx: string, execution_tx?: string | null, veto_tx?: string | null, vote_count: number, execution_ready: boolean, executed: boolean, vetoed: boolean, completed: boolean, cancelled: boolean, space: { __typename?: 'Space', id: string, controller: string, authenticators: Array<string | null>, metadata?: { __typename?: 'SpaceMetadataItem', id: string, name: string, avatar: string, voting_power_symbol: string, treasuries: Array<string | null>, executors: Array<string | null>, executors_types: Array<string | null>, executors_strategies: Array<{ __typename?: 'ExecutionStrategy', id: string, address: string, destination_address?: string | null, type: string, treasury_chain?: number | null, treasury?: string | null } | null> } | null, strategies_parsed_metadata: Array<{ __typename?: 'StrategiesParsedMetadataItem', index: number, data?: { __typename?: 'StrategiesParsedMetadataDataItem', id: string, name: string, description: string, decimals: number, symbol: string, token?: string | null, payload?: string | null } | null } | null> }, author: { __typename?: 'User', id: string, address_type: number }, metadata?: { __typename?: 'ProposalMetadataItem', id: string, title?: any | null, body?: any | null, discussion?: any | null, execution?: any | null } | null } & { ' $fragmentName'?: 'ProposalFragmentFragment' };

export type ProposalsQueryQueryVariables = Exact<{
...
export type ProposalsQueryQuery = { __typename?: 'Query', proposals?: Array<(
    { __typename?: 'Proposal' }
    & { ' $fragmentRefs'?: { 'ProposalFragmentFragment': ProposalFragmentFragment } }
  ) | null> | null };

export type UserVotesQueryQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
