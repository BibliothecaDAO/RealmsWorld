import type { TransactionStatus } from "@starkware-industries/commons-js-enums";
import { isOnChain } from "@starkware-industries/commons-js-enums";
...
export const isWithdrawal = (type: TransferType) =>
...
export const isPendingWithdrawal = ({
  ...
  return (
    isWithdrawal(type) &&
    !l1TxHash &&
    ((!fastWithdrawal && isOnChain(l2TxStatus)) ||
      (fastWithdrawal && customData))
  );
};
