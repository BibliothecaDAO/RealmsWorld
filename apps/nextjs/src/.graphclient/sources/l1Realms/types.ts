...
export namespace L1RealmsTypes {
  ...
  export interface QuerySdk {
    ...
    /** null **/
    realmResource: InContextSdkMethod<
      Query["realmResource"],
      QueryrealmResourceArgs,
      MeshContext
    >;
    /** null **/
    realmResources: InContextSdkMethod<
      Query["realmResources"],
      QueryrealmResourcesArgs,
      MeshContext
    >;
    /** null **/
    wallet: InContextSdkMethod<Query["wallet"], QuerywalletArgs, MeshContext>;
    /** null **/
    wallets: InContextSdkMethod<
      Query["wallets"],
      QuerywalletsArgs,
      MeshContext
    >;
  ...
  export interface SubscriptionSdk {
    ...
    >;
    /** null **/
    realm: InContextSdkMethod<
      Subscription["realm"],
      SubscriptionrealmArgs,
      MeshContext
    >;
    /** null **/
    realms: InContextSdkMethod<
      Subscription["realms"],
      SubscriptionrealmsArgs,
      MeshContext
    >;
    /** null **/
    realmResource: InContextSdkMethod<
      Subscription["realmResource"],
      SubscriptionrealmResourceArgs,
      MeshContext
    >;
    /** null **/
    realmResources: InContextSdkMethod<
      Subscription["realmResources"],
      SubscriptionrealmResourcesArgs,
      MeshContext
    >;
    /** null **/
    wallet: InContextSdkMethod<
      Subscription["wallet"],
      SubscriptionwalletArgs,
      MeshContext
    >;
    /** null **/
    wallets: InContextSdkMethod<
      Subscription["wallets"],
      SubscriptionwalletsArgs,
      MeshContext
    >;
    /** null **/
    transfer: InContextSdkMethod<
