...
export type RealmTraitOption = "regions" | "cities" | "harbors" | "rivers";
...
export type Resource_orderBy = "id" | "name" | "totalRealms" | "realms";
...
> = ResolversObject<{
  l2deposits?: Resolver<
    ResolversTypes["L2Deposit"][],
    ParentType,
    ContextType,
    RequireFields<
      Queryl2depositsArgs,
      "first" | "skip" | "orderBy" | "orderByDirection" | "where"
    >
  >;
  deposit?: Resolver<
  ...
  >;
  l2withdrawals?: Resolver<
    ResolversTypes["L2Withdrawal"][],
    ParentType,
    ContextType,
    RequireFields<
  ...
  beasts?: Resolver<
    ...
    >
  >;
  depositEvent?: Resolver<
    Maybe<ResolversTypes["DepositEvent"]>,
    ParentType,
    ContextType,
    RequireFields<QuerydepositEventArgs, "id" | "subgraphError">
  >;
  depositEvents?: Resolver<
    ResolversTypes["DepositEvent"][],
    ParentType,
    ContextType,
    RequireFields<QuerydepositEventsArgs, "skip" | "first" | "subgraphError">
  >;
  deposits?: Resolver<
  ...
  >;
  withdrawalEvent?: Resolver<
    Maybe<ResolversTypes["WithdrawalEvent"]>,
    ParentType,
    ContextType,
    RequireFields<QuerywithdrawalEventArgs, "id" | "subgraphError">
  >;
  withdrawalEvents?: Resolver<
    ResolversTypes["WithdrawalEvent"][],
    ParentType,
    ContextType,
    RequireFields<QuerywithdrawalEventsArgs, "skip" | "first" | "subgraphError">
  >;
  withdrawal?: Resolver<
    Maybe<ResolversTypes["Withdrawal"]>,
    ParentType,
    ContextType,
    RequireFields<QuerywithdrawalArgs, "id" | "subgraphError">
  >;
  withdrawals?: Resolver<
    ResolversTypes["Withdrawal"][],
    ParentType,
    ContextType,
    RequireFields<QuerywithdrawalsArgs, "skip" | "first" | "subgraphError">
  >;
  token?: Resolver<
  ...
  >;
  realm?: Resolver<
    Maybe<ResolversTypes["Realm"]>,
    ParentType,
    ContextType,
    RequireFields<QueryrealmArgs, "id" | "subgraphError">
  >;
  realms?: Resolver<
    ResolversTypes["Realm"][],
    ParentType,
    ContextType,
    RequireFields<QueryrealmsArgs, "skip" | "first" | "subgraphError">
  >;
  realmResource?: Resolver<
    Maybe<ResolversTypes["RealmResource"]>,
    ParentType,
    ContextType,
    RequireFields<QueryrealmResourceArgs, "id" | "subgraphError">
  >;
  realmResources?: Resolver<
    ResolversTypes["RealmResource"][],
    ParentType,
    ContextType,
    RequireFields<QueryrealmResourcesArgs, "skip" | "first" | "subgraphError">
  >;
  wallet?: Resolver<
  ...
  wallets?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QuerywalletsArgs, "skip" | "first" | "subgraphError">
  >;
  transfer?: Resolver<
...
export type L2DepositResolvers<
  ContextType = MeshContext,
  ParentType extends
    ResolversParentTypes["L2Deposit"] = ResolversParentTypes["L2Deposit"],
> = ResolversObject<{
...
export type L2WithdrawalResolvers<
  ContextType = MeshContext,
  ParentType extends
    ResolversParentTypes["L2Withdrawal"] = ResolversParentTypes["L2Withdrawal"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type BeastResolvers<
  ContextType = MeshContext,
  ParentType extends
    ResolversParentTypes["Beast"] = ResolversParentTypes["Beast"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
> = ResolversObject<{
  depositEvent?: SubscriptionResolver<
    Maybe<ResolversTypes["DepositEvent"]>,
    "depositEvent",
    ParentType,
    ContextType,
    RequireFields<SubscriptiondepositEventArgs, "id" | "subgraphError">
  >;
  depositEvents?: SubscriptionResolver<
    ResolversTypes["DepositEvent"][],
    "depositEvents",
    ParentType,
    ContextType,
  ...
  >;
  withdrawalEvent?: SubscriptionResolver<
    Maybe<ResolversTypes["WithdrawalEvent"]>,
    "withdrawalEvent",
    ParentType,
    ContextType,
    RequireFields<SubscriptionwithdrawalEventArgs, "id" | "subgraphError">
  >;
  withdrawalEvents?: SubscriptionResolver<
    ResolversTypes["WithdrawalEvent"][],
    "withdrawalEvents",
    ParentType,
    ContextType,
    ...
    >
  >;
  withdrawal?: SubscriptionResolver<
    Maybe<ResolversTypes["Withdrawal"]>,
    "withdrawal",
    ParentType,
    ContextType,
    RequireFields<SubscriptionwithdrawalArgs, "id" | "subgraphError">
  >;
  withdrawals?: SubscriptionResolver<
    ResolversTypes["Withdrawal"][],
    "withdrawals",
    ParentType,
    ContextType,
  ...
  >;
  realm?: SubscriptionResolver<
    Maybe<ResolversTypes["Realm"]>,
    "realm",
    ParentType,
    ContextType,
    RequireFields<SubscriptionrealmArgs, "id" | "subgraphError">
  >;
  realms?: SubscriptionResolver<
    ResolversTypes["Realm"][],
    "realms",
    ParentType,
    ContextType,
    RequireFields<SubscriptionrealmsArgs, "skip" | "first" | "subgraphError">
  >;
  realmResource?: SubscriptionResolver<
    Maybe<ResolversTypes["RealmResource"]>,
    "realmResource",
    ParentType,
    ContextType,
    RequireFields<SubscriptionrealmResourceArgs, "id" | "subgraphError">
  >;
  realmResources?: SubscriptionResolver<
    ResolversTypes["RealmResource"][],
    "realmResources",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptionrealmResourcesArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  ...
  wallets?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubscriptionwalletsArgs, "skip" | "first" | "subgraphError">
  >;
...
export type DepositResolvers<
  ContextType = MeshContext,
  ParentType extends
    ResolversParentTypes["Deposit"] = ResolversParentTypes["Deposit"],
> = ResolversObject<{
  ...
  depositEvents?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<DepositdepositEventsArgs, "skip" | "first">
  >;
...
export type DepositEventResolvers<
  ContextType = MeshContext,
  ParentType extends
    ResolversParentTypes["DepositEvent"] = ResolversParentTypes["DepositEvent"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  ...
  finishedAtBlock?: Resolver<
    Maybe<ResolversTypes["BigInt"]>,
    ParentType,
    ContextType
  >;
  finishedAtDate?: Resolver<
    Maybe<ResolversTypes["BigInt"]>,
    ParentType,
    ContextType
  >;
  finishedTxHash?: Resolver<
...
export type WithdrawalResolvers<
  ContextType = MeshContext,
  ParentType extends
    ResolversParentTypes["Withdrawal"] = ResolversParentTypes["Withdrawal"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  ...
  withdrawalEvents?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<WithdrawalwithdrawalEventsArgs, "skip" | "first">
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type WithdrawalEventResolvers<
  ContextType = MeshContext,
  ParentType extends
    ResolversParentTypes["WithdrawalEvent"] = ResolversParentTypes["WithdrawalEvent"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  bridgeAddressL1?: Resolver<ResolversTypes["Bytes"], ParentType, ContextType>;
  bridgeAddressL2?: Resolver<ResolversTypes["Bytes"], ParentType, ContextType>;
...
export type RealmResolvers<
  ContextType = MeshContext,
  ParentType extends
    ResolversParentTypes["Realm"] = ResolversParentTypes["Realm"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  ...
  resources?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<RealmresourcesArgs, "skip" | "first">
  >;
  ...
  bridgedOwner?: Resolver<
    Maybe<ResolversTypes["Wallet"]>,
    ParentType,
    ContextType
  >;
  bridgedV2Owner?: Resolver<
    Maybe<ResolversTypes["Wallet"]>,
    ParentType,
    ContextType
  >;
...
export type RealmResourceResolvers<
  ContextType = MeshContext,
  ParentType extends
    ResolversParentTypes["RealmResource"] = ResolversParentTypes["RealmResource"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
...
> = ResolversObject<{
  ...
  realms?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<ResourcerealmsArgs, "skip" | "first">
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
> = ResolversObject<{
  ...
  realms?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<WalletrealmsArgs, "skip" | "first">
  >;
  realmsHeld?: Resolver<ResolversTypes["BigInt"], ParentType, ContextType>;
  bridgedRealmsHeld?: Resolver<
    ResolversTypes["BigInt"],
    ParentType,
    ContextType
  >;
  bridgedV2RealmsHeld?: Resolver<
    ResolversTypes["BigInt"],
    ParentType,
    ContextType
  >;
...
export type MeshContext = ApibaraTypes.Context &
  LordsbridgeTypes.Context &
  L1RealmsTypes.Context &
  BaseMeshContext;
...
export async function getMeshOptions(): Promise<GetMeshOptions> {
  ...
  const lordsbridgeHandler = new GraphqlHandler({
    ...
    config: {
      endpoint:
        "https://api.thegraph.com/subgraphs/name/{context.subgraphName:redbeardeth/starknet-bridge-mainnet}",
    },
    baseDir,
    cache,
    pubsub,
  ...
  const apibaraHandler = new GraphqlHandler({
    name: "apibara",
    config: {
      endpoint: "http://localhost:8080/{context.apibaraHandle:goerli-graphql}",
    },
    baseDir,
    cache,
    pubsub,
  ...
  const l1RealmsHandler = new GraphqlHandler({
    ...
    config: {
      endpoint:
        "https://api.thegraph.com/subgraphs/name/{context.realmsSubgraph:bibliothecaforadventurers/realms}",
    },
    baseDir,
    cache,
    pubsub,
...
export interface BeastsQuery {
  beasts: Pick<
    Beast,
    "id" | "name" | "image" | "level" | "tier" | "prefix" | "suffix" | "owner"
  >[];
}
...
export interface WalletsRealmsQuery {
  wallets: Pick<
    Wallet,
    "realmsHeld" | "bridgedRealmsHeld" | "bridgedV2RealmsHeld"
  >[];
}
...
export interface L2WithdrawalsQuery {
  l2withdrawals: Pick<
    L2Withdrawal,
    "l2Sender" | "l1Recipient" | "amount" | "timestamp"
  >[];
  deposits: (Pick<
    Deposit,
    "id" | "l1Sender" | "l2Recipient" | "createdTimestamp"
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    Beasts(
      variables?: BeastsQueryVariables,
      options?: C,
    ): Promise<BeastsQuery> {
      return requester<BeastsQuery, BeastsQueryVariables>(
        BeastsDocument,
        variables,
        options,
      ) as Promise<BeastsQuery>;
    },
    Deposits(
      variables?: DepositsQueryVariables,
      options?: C,
    ): Promise<DepositsQuery> {
      return requester<DepositsQuery, DepositsQueryVariables>(
        DepositsDocument,
        variables,
        options,
      ) as Promise<DepositsQuery>;
    },
    WalletsRealms(
      variables?: WalletsRealmsQueryVariables,
      options?: C,
    ): Promise<WalletsRealmsQuery> {
      return requester<WalletsRealmsQuery, WalletsRealmsQueryVariables>(
        WalletsRealmsDocument,
        variables,
        options,
      ) as Promise<WalletsRealmsQuery>;
    },
    UsersRealms(
      variables: UsersRealmsQueryVariables,
      options?: C,
    ): Promise<UsersRealmsQuery> {
      return requester<UsersRealmsQuery, UsersRealmsQueryVariables>(
        UsersRealmsDocument,
        variables,
        options,
      ) as Promise<UsersRealmsQuery>;
    },
    L2Withdrawals(
      variables?: L2WithdrawalsQueryVariables,
      options?: C,
    ): Promise<L2WithdrawalsQuery> {
      return requester<L2WithdrawalsQuery, L2WithdrawalsQueryVariables>(
        L2WithdrawalsDocument,
        variables,
        options,
      ) as Promise<L2WithdrawalsQuery>;
    },
    Withdrawals(
      variables?: WithdrawalsQueryVariables,
      options?: C,
    ): Promise<WithdrawalsQuery> {
      return requester<WithdrawalsQuery, WithdrawalsQueryVariables>(
        WithdrawalsDocument,
        variables,
        options,
      ) as Promise<WithdrawalsQuery>;
    },
  };
}
