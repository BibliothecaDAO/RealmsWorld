...
export const games: Game[] = [
  ...
  },
  {
    ...
    longform:
      "Inspired by Carcassonne, Paved is a strategic tile-matching game where players compete to build the most valuable city. Solo mode and multiplayer mode are available, with the latter allowing players to compete for rewards.",
    links: {
